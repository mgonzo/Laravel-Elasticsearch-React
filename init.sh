...
yum install -y nginx php56w-fpm.x86_64 php56w.x86_64 php56w-cli.x86_64 php56w-common.x86_64 php56w-devel.x86_64 php56w-gd.x86_64 php56w-intl.x86_64 php56w-mbstring.x86_64 php56w-mcrypt.x86_64 php56w-mysqlnd.x86_64 php56w-pdo.x86_64 php56w-pear.noarch php56w-pecl-apc.x86_64 php56w-pecl-imagick.x86_64 php56w-pecl-memcache.x86_64 php56w-pecl-memcached.x86_64 php56w-pecl-mongo.x86_64 php56w-pecl-redis.x86_64 php56w-soap.x86_64 php56w-suhosin.x86_64 php56w-xml.x86_64 git.x86_64 mlocate ruby.x86_64 newrelic-daemon.x86_64 newrelic-php5.x86_64 newrelic-php5-common.noarch newrelic-repo.noarch newrelic-sysmond.x86_64 
...
echo 'date.timezone = "America/Los_Angeles"' >> /etc/php.ini
